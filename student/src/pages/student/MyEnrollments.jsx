          ...
          {enrolledCourses.map((course,index)=>(
            <tr key={index} className='border-b border-gray-500/20'>
              ...
              <td className='px-4 py-3 max-sm:hidden text-right'>
                <button className='px-3 sm:px-5 py-1.5 sm:py-2 bg-blue-600 max-sm:text rounded-md hover:bg-blue-800 text-white cursor-pointer' onClick={()=>navigate('/player/'+course._id)}>
